...
void multiply_recursive(int **A, int **B, int **C, int n)
{
    ...
    free_matrix(Temp1, new_n);
    free_matrix(Temp2, new_n);
}
void strassen_multiply(int **A, int **B, int **C, int n)
{
    ...
    free_matrix(AResult, new_n);
    free_matrix(BResult, new_n);
}
int main()
{
    srand(time(NULL));
    printf("time taken for iterative multiplication\n");
    printf("%-10s %-15s\n", "Size (n)", "Time (sec)");
    ...
    printf("time taken for strassen multiplication\n");
    printf("%-10s %-15s\n", "Size (n)", "Time (sec)");
    for (int n = 2; n <= 256; n *= 2)
    {
        int **A = allocate_matrix(n);
    ...
    printf("time taken for recurssive multiplication\n");
    printf("%-10s %-15s\n", "Size (n)", "Time (sec)");
    for (int n = 2; n <= 256; n *= 2)
    {
        int **A = allocate_matrix(n);
